...
- Logical soundness
- Honesty and absence of overclaiming
- Completeness relative to the provided context

Be rigorous but fair. Provide structured scores (0.0-1.0) for key dimensions and an overall assessment.

Output JSON with fields for the individual scores and an overall critique.