...
Placeholder: Corpus Workbench — Not yet implemented.
"""
...
async def corpus_page():
    """Corpus Workbench — Not yet implemented."""
    ...
    with ui.column().classes("flex-1").style(
        ...
        ui.label(
            "Planned for a future UI cycle. Available via CLI:\n"
            "  aip corpus stats\n"
            "  aip ingest file <path>"
        ).style(
