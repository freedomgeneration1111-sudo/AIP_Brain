...
2. Dispatches to all enabled Retriever implementations
3. Applies RRF fusion across channels
4. Applies importance weighting and budget curation
5. Produces a RetrievalTrace with full instrumentation
...
from orchestration.retrievers (FTSRetriever, rrf_fuse).
"""
